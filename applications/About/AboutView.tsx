...
function HomeSubView(params: SubViewParams) {
  ...
  return (<>
    <div className={styles['subpage-home']}>
      <h1 className={styles['home-title']}>Ridho Assuryadi</h1>
      <h3 className={styles['home-subtitle']}>S engineer</h3>
  ...
  function RenderDutchContent() {
    return (
      <div>
        ...
        <p>
          Ik ben Ridho Assuryadi, een software ontwikkelaar in Nederland.
        </p>
  ...
  function RenderEnglishContent() {
    return (
      <div>
        ...
        <p>
          I’m Ridho Assuryadi, a software engineer from indonesia.
        </p>
