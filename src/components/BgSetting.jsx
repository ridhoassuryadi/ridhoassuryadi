...
function BgSetting() {
  ...
  const colorOptions = [
    { value: 1, label: '(None)', color: '#6E8898', image: bg0, barColor: '#14045c' },
    {
      value: 13,
    ...
    { value: 14, label: 'Computer Disk', color: '#6E8898', image: bg12, barColor: '#14045c' },
  ]
  ...
  return (
    <Draggable
      ...
      cancel={'.folder_barbtn_bgsetting'}
      grid={[1, 1]}
      scale={1}
        ...
        <div className="folder_content">
          ...
          {bgTap && (
            <div className="folder_content-bgsetting">
              ...
              <div className="preview_bg" style={{ backgroundColor: userPickedColor ? userPickedColor : '' }}>
                {ImgBgPreview && <img src={ImgBgPreview} alt="" />}
              </div>
              {pickerPanel && (
                <div className="color_picker_container" onClick={(e) => e.stopPropagation()}>
                  <SketchPicker
                    color={userPickedColor}
                    onChange={(color) => {
                    ...
                    {colorOptions.map((option) => (
                      <ul
                        ...
                        onClick={(e) => {
                          ...
                          option.value === 13 ? setPickerPanel(true) : setPickerPanel(false)
                        }}
                        style={selectedBg2 === option.value ? { background: '#040482', color: 'white' } : {}}
                      >
                        {option.label}
                        {option.value === 13 && (
                          <span style={{ position: 'relative', left: '8px' }}>{userPickedColor}</span>
                        )}
                      </ul>
                    ))}
                  </div>
          ...
          {effectTap && (
            <div className="folder_content-bgsetting">
              <img alt="bgsettingPC" className="bgsetting_img" src={bgPic} />
              <div className="preview_bg">{ImgBgPreviewEffect && <img src={ImgBgPreviewEffect} alt="" />}</div>
              <div className="bgsettingtext_container">
                <div className="wallpaper">
                  <p>Effect</p>
                  ...
                  <div className="wallpaper_container">
                    {effectOptions.map((option) => (
                      <ul
                        ...
                        style={selectedBg2Effect === option.value ? { background: '#040482', color: 'white' } : {}}
                      >
                        {option.label}
                      </ul>
                    ))}
