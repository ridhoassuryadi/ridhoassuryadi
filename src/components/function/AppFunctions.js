...
// click to open links
export function handleDoubleClickiframe(name, _setOpenProjectExpand, setProjectUrl) {
  switch (name) {
    case 'Nft':
    ...
    case 'AiAgent':
      setProjectUrl('https://raizora.github.io/AI_chatbot/')
      break

    case '3dObject':
      setProjectUrl('https://raizora.github.io/3d_book/')
      break

    case 'Fortune':
      setProjectUrl('https://raizora.github.io/week_fortune/')
      break
...
export function handleDoubleTapiframeMobile(name, lastTapTime, setLastTapTime, _setOpenProjectExpand, setProjectUrl) {
  const now = Date.now()
  if (now - lastTapTime < 300) {
    switch (name) {
      case 'Nft':
...
export function handleDoubleClickEnterLink(name, handleshow) {
  switch (name) {
    case 'Nft':
      window.open('https://opennft.netlify.app/', '_blank')
      break
    case 'Note':
      window.open('https://fullstack-stickynotes.netlify.app/', '_blank')
      break
    case 'Type':
      window.open('https://raizora.github.io/typingGame/', '_blank')
      break
    case '3dObject':
      window.open('https://raizora.github.io/3d_book/', '_blank')
      break
    case 'Fortune':
      window.open('https://raizora.github.io/week_fortune/', '_blank')
      break
    case 'Github':
      handleshow('Github')
      break
...
export function handleDoubleTapEnterMobile(name, lastTapTime, setLastTapTime, _setOpenProjectExpand, _setProjectUrl) {
  const now = Date.now()
  if (now - lastTapTime < 300) {
    switch (name) {
      case 'Nft':
      ...
      case 'Type':
        ...
        break
      case 'Github':
        window.open('https://github.com/raizora/wins95Portfolio/', '_blank')
        break
      case '3dObject':
        window.open('https://raizora.github.io/3d_book/', '_blank')
        break
