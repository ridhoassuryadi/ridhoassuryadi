  ...
  return (
    ...
    >
      <motion.div
        ...
        onClick={(e) => {
          e.stopPropagation()
          if (!MyComputerExpand.focusItem) playSound('windowFocus')
          handleSetFocusItemTrue('MyComputer')
        }}
        style={{
          ...(MyComputerExpand.expand ? inlineStyleExpand('MyComputer') : inlineStyle('MyComputer')),
      ...
      >
        ...
        >
          <div className="folder_barname">
            <img
              src={
                imageMapping(selectedFolder.label) === null
                            ...
                            subFolder.folderId === icon.at && (
                              <>
                                ...
                                >
                                  <img
                                    src={
                                      imageMapping(subFolder.name) === null
                                        ? imageMapping(subFolder.name, 'folder')
                                        : imageMapping(subFolder.name)
                                    }
                                    alt=""
                                    ...
                                    <li
                                      ...
                                      onClick={() => {
                                        setSelectedFolder({
                                          ...
                                          img:
                                            imageMapping(subSubFolder.name) === null
                                              ? imageMapping(subSubFolder.name, 'folder')
                                              : imageMapping(subSubFolder.name),
                                        })
                                        setPopUpFolder(false)
        ...
        >
          <div className="parent_item_container" key={key} onClick={() => handleSetFocusItemTrue('MyComputer')}>
            <div
