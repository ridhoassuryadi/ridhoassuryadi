...
function NewsApp() {
  ...
  const { tileScreen, city, setCity, Cel, setCel, weather, setWeather, newsPopup, setNewsPopup } =
  ...
  useEffect(() => {
    // call fetchNews when user open news
    fetchNews()
  }, [])
  ...
  useEffect(() => {
    // update weather and location since tile screen is active
    getUserLocation()
  }, [tileScreen])
          ...
          {weather && (
            <div className="weather_container">
              ...
              <h1>
                ...
                <span className="temp" onClick={() => setCel(!Cel)}>
