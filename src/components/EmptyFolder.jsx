...
function EmptyFolder({ state, setState, refState, folderName, photoMode, paintMode, userCreatedFolderMode, type }) {
  ...
  useEffect(() => {
    // force re-render, ref can be tracked
  ...
  return (
    ...
    >
      <motion.div
        ...
        ref={refState}
        className={`folder_folder ${photoMode ? 'photo_mode' : paintMode ? 'paint_mode' : ''}`}
        onClick={(e) => {
          e.stopPropagation()
          handleSetFocusItemTrue(folderName)
        }}
      ...
      >
        ...
        {paintMode ? ( // run paint
          ...
          <>
            ...
            >
              <div className="parent_item_container" key={key} style={photoMode ? parentItemContainerStyle : {}}>
                <div
                    ...
                    .map((icon) => (
                      <Fragment key={icon.name}>
                        ...
                        >
                          ...
                          >
                            <img
                              src={imageMapping(icon.pic, type)}
                              alt="#"
