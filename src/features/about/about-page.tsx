    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          Hey, I&apos;m Ridho. I&apos;m a Software Engineer who loves design. I&apos;m currently working as an Engineering Manager at Red Ant Colony and Co-Founder at Raizora. Previously, I was building Design Systems at Ruangguru and crafting amazing things at Ruangkerja, an LMS for training companies and organizations.
        </Paragraph>
        <Paragraph className=" mt-4">
          I started my career as a Designer right after graduating from senior high school. After 1 year, I decided to join a coding bootcamp. After that, I entered the world of IT as a software engineer. I have worked with many startups, and I&apos;m grateful to have had opportunities to lead and grow teams starting from the early stage of my career.
        </Paragraph>
