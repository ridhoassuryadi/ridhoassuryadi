      ...
      <div className="[mask-image:_linear-gradient(to_right,black_50%,transparent_90%)] md:[mask-image:_linear-gradient(to_right,transparent_48px,black_64px,black_50%,transparent_90%)] -mx-3 md:-mx-16">
        ...
        >
          {items.map((item, index) => (
            <article
              key={index}
              className="shrink-0 w-[66.6667%] p-5 rounded-xl relative before:absolute before:inset-0 before:rounded-[inherit] before:-z-10 before:transition before:duration-300 data-[state=active]:before:bg-linear-to-tr data-[state=active]:before:from-gray-100 data-[state=active]:before:to-gray-50 before:opacity-0 data-[state=active]:before:opacity-100"
            >
              ...
              <p className="font-inter-tight font-semibold text-gray-800 before:content-['\201C'] after:content-['\201D']">
                {item.content}
              </p>
            </article>
          ))}
